...
# ensure sbp_build can log in
Write-Host "Setting sbp_build user file permissions"
New-Item -ItemType Directory -Force -Path "C:\Users\sbp_build\.ssh"
C:\Windows\System32\icacls.exe "C:\Users\sbp_build" /grant "sbp_build:(OI)(CI)F"
C:\Windows\System32\icacls.exe "C:\Program Files\OpenSSH\bin" /grant "sbp_build:(OI)RX"
C:\Windows\System32\icacls.exe "C:\Program Files\OpenSSH\usr\sbin" /grant "sbp_build:(OI)RX"
...
C:\Windows\System32\icacls.exe "C:\Windows\Temp" /grant "sbp_build:(OI)(CI)F"
...
Set-Content C:\Users\sbp_build\.ssh\environment $sshenv
